...
namespace HostelProject.Controllers.AdminControllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(UserManager<User> userManager, IRepository<Mentor> mentorRepository)
        {
        ...
        public async Task<IActionResult> Create(CreateUserViewModel model)
        {
            ...
            {
                if(!await CheckEmailInDataBaseAsync(model.Email))
                {
        ...
        public async Task<ActionResult> Delete(string id)
        {
            ...
            var listMentors = _mentorRepository.GetAll().ToList();

            foreach (var item in listMentors)
            {
                if (item.UserId.Replace(" ", "") == user.Id)
                {
                    item.UserId = null;
                    await _mentorRepository.Edit(item);
                }
            }
